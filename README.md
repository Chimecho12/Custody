...
**불확실성 표현 사용자 시험 (`scripts/user-study.py`, `docs/user-study-protocol.md`):** 보고서 §5 의 세 표현 중 어느 것이
"확인할 수 없음" 을 "위반 없음" 으로 오독하게 하는지는 아직 사람에게 물어본 적이 없다. 절차·정답 키·채점기만 있고
결과는 없다. 참가자 5명 이상의 결과가 나오기 전까지 어느 표현도 더 낫다고 주장하지 않는다.
